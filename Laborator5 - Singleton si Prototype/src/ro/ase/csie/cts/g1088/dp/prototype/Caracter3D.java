...
public class Caracter3D implements Cloneable{
	...
	//pt colectii in java nu putem folosi primitive
	...
	//pt concatenare de stringuri folosim stringbuilder
	@Override
	...
	protected Object clone() throws CloneNotSupportedException {
		//clone de aici face shallow copy
		//return super.clone();
		
		//nici acesta nu e ok, NU PRIN ACELASI CONSTRUCTOR-asta era pb initiala
