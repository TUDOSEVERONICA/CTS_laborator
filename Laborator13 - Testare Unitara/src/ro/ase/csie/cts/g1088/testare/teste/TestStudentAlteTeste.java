...
import ro.ase.csie.cts.g1088.testare.categorii.TestImportant;
...
public class TestStudentAlteTeste {
	...
	//se executa de fiecare daca cand se ruleaza un test
	@Before
	...
	public void testGetMediePerformance() throws ExceptieNota {
		...
		if(durata<=10) {
			...
			fail("Calculul mediei dureazaa mai mult de 10 milisecunde");
		}
	}
